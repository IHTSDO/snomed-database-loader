...
FROM 'RF2Release/Full/Terminology/sct2_Relationship_Full_INT_20150731.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
...
FROM 'RF2Release/Full/Terminology/sct2_StatedRelationship_Full_INT_20150731.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_langrefset_f(id, effectivetime, active, moduleid, refsetid, referencedcomponentid, acceptabilityid)
FROM 'RF2Release/Full/Refset/Language/der2_cRefset_LanguageFull-en_INT_20150731.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_associationrefset_d(id, effectivetime, active, moduleid, refsetid, referencedcomponentid, targetcomponentid)
FROM 'RF2Release/Full/Refset/Content/der2_cRefset_AssociationReferenceFull_INT_20150731.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_simplerefset_f(id, effectivetime, active, moduleid, refsetid, referencedcomponentid)
FROM 'RF2Release/Full/Refset/Content/der2_Refset_SimpleFull_INT_20150731.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
...
FROM 'RF2Release/Full/Refset/Map/der2_iissscRefset_ComplexMapFull_INT_20150731.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
...
FROM 'RF2Release/Full/Refset/Map/der2_iisssccRefset_ExtendedMapFull_INT_20150731.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
