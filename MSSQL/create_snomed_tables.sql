...
id bigint NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_D_EFF_TIME DEFAULT 0,
...
effectiveTime datetime NOT NULL CONSTRAINT DF_I_EFF_TIME DEFAULT 0,
...
id bigint NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_R_EFF_TIME DEFAULT 0,
...
id bigint NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_SR_EFF_TIME DEFAULT 0,
...
id bigint NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_TD_EFF_TIME DEFAULT 0,
...
effectiveTime datetime NOT NULL CONSTRAINT DF_RS_C_EFF_TIME DEFAULT 0,
...
id BINARY(16) NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_RS_EFF_TIME DEFAULT 0,
...
id BINARY(16) NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_RS_I_CC_EFF_TIME DEFAULT 0,
...
id BINARY(16) NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_RS_I_C_EFF_TIME DEFAULT 0,
...
id BINARY(16) NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_RS_S_EFF_TIME DEFAULT 0,
...
id BINARY(16) NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_RS_CCI_EFF_TIME DEFAULT 0,
...
id BINARY(16) NOT NULL ,
effectiveTime datetime NOT NULL CONSTRAINT DF_RS_CI_EFF_TIME DEFAULT 0,
...
CREATE TABLE sct2_refset_ss (
    id BINARY(16) NOT NULL ,
    effectiveTime datetime NOT NULL CONSTRAINT DF_RS_SS_EFF_TIME DEFAULT 0,
