...
FROM 'RF2Release/Full/Terminology/sct2_Relationship_Full_INT_20130731.txt'
WITH DELIMITER '\t';
CSV HEADER;
...
FROM 'RF2Release/Full/Refset/Crossmap/der2_iissscRefset_ComplexMapFull_INT_20130731.txt'
WITH DELIMITER '\t';
CSV HEADER;
