...
--
DROP TABLE IF EXISTS snomedct.tmp1;
DROP TABLE IF EXISTS snomedct.tmp2;
DROP TABLE IF EXISTS snomedct.tmp3;

CREATE TEMPORARY TABLE IF NOT EXISTS snomedct.tmp1 (
  `id` bigint(20) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO tmp1 SELECT subtypeId FROM snomedct.ss_transclose as tc WHERE tc.supertypeId = 404684003;
...
FROM tmp1, snomedct.sva_pref as pt
