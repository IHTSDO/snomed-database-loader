...
-- 
-- Release Package: RF2Releas
-- Package Code: SPANISH-ES
-- Release Date: 20190430
-- Extension not including root concept
-- RFS Specification Creation: 20200115172418
-- 
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Refset/Content/der2_cRefset_AttributeValueSpanishExtensionFull_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Refset/Language/der2_cRefset_LanguageSpanishExtensionFull-es_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Refset/Metadata/der2_cRefset_MRCMModuleScopeSpanishExtensionFull_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Refset/Metadata/der2_cciRefset_RefsetDescriptorSpanishExtensionFull_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Refset/Metadata/der2_ssRefset_ModuleDependencySpanishExtensionFull_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Terminology/sct2_Concept_SpanishExtensionFull_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Terminology/sct2_Description_SpanishExtensionFull-es_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Terminology/sct2_Relationship_SpanishExtensionFull_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Terminology/sct2_TextDefinition_SpanishExtensionFull-es_INT_$RELDATE.txt'
INTO TABLE `full_description`
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);
...
LOAD DATA LOCAL INFILE '$RELPATH/Full/Terminology/sct2_sRefset_OWLExpressionSpanishExtensionFull_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Refset/Content/der2_cRefset_AttributeValueSpanishExtensionSnapshot_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Refset/Language/der2_cRefset_LanguageSpanishExtensionSnapshot-es_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Refset/Metadata/der2_cRefset_MRCMModuleScopeSpanishExtensionSnapshot_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Refset/Metadata/der2_cciRefset_RefsetDescriptorSpanishExtensionSnapshot_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Refset/Metadata/der2_ssRefset_ModuleDependencySpanishExtensionSnapshot_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Terminology/sct2_Concept_SpanishExtensionSnapshot_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Terminology/sct2_Description_SpanishExtensionSnapshot-es_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Terminology/sct2_Relationship_SpanishExtensionSnapshot_INT_$RELDATE.txt'
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Terminology/sct2_TextDefinition_SpanishExtensionSnapshot-es_INT_$RELDATE.txt'
INTO TABLE `snap_description`
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(`id`,`effectiveTime`,`active`,`moduleId`,`conceptId`,`languageCode`,`typeId`,`term`,`caseSignificanceId`);
...
LOAD DATA LOCAL INFILE '$RELPATH/Snapshot/Terminology/sct2_sRefset_OWLExpressionSpanishExtensionSnapshot_INT_$RELDATE.txt'
